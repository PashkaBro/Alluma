...
let nightKill
let dayKill
 data.game5.night.length > 0?
 nightKill = data.game5.night.split(',') : nightKill = []
 data.game5.day.lenght > 0?
 dayKill = data.game5.day.split(',') :  dayKill = []

class Game5 extends Base {
    night() {
    ...
    playersSelect() {
        this.moderLogin();
        $(sel.btnLogout).waitForDisplayed(1000)

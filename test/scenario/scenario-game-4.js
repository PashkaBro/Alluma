...
let nightKill
let dayKill
 data.game4.night.length > 0?
 nightKill = data.game4.night.split(',') : nightKill = []
 data.game4.day.lenght > 0?
 dayKill = data.game4.day.split(',') :  dayKill = []

class Game4 extends Base {
    night() {
